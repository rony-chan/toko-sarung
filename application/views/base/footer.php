...
<div class="modal fade" id="id_register" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      ...
      <div class="modal-body">
          <form method="POST" action="<?php echo site_url('beranda/register');?>" class="form-horizontal" role="form">
            <div class="form-group">
    ...
    <script>
        jQuery(document).ready(function ($) {
            ...
            var options = {
                ...
                $SlideWidth: 1050,                                 //[Optional] Width of every slide in pixels, default value is width of 'slides' container
            ...
            function ScaleSlider() {
                ...
                if (parentWidth)
                    jssor_slider1.$ScaleWidth(Math.min(parentWidth, 1050));
                else
