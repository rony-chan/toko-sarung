          ...
          intputElements[i].oninvalid = function (e) {
            ...
            if (!e.target.validity.valid) {
              if (e.target.name == "jumlah") {
                e.target.setCustomValidity("Jumlah Tidak Boleh Kosong, 0 atau melebihi dari stok");
          }
          else {
             ...
             <div class="col-md-8"><h3><a href="#"><?php echo $view['nama']?></a></h3><h4>Rp <?php echo number_format($view['harga'])?>/kodi</h4>
              ...
              <form method="POST" action="<?php echo site_url('order/addToCart') ?>" class="form-inline" role="form">
                   <div class="form-group">
                        ...
                        <input id="inputjumlah" name="jumlah" style="width:200px" type="number" min="1" max="<?php echo $view['jumlah']?>" class="form-control" id="exampleInputEmail2" placeholder="Jumlah Kodi" required>
